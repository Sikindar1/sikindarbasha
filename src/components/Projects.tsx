  ...
  const projects = [
    {
      ...
      github: 'https://github.com/Sikindar1/Project/tree/main/src',
      demo: '#',
    },
    {
      ...
      github: 'https://github.com/Sikindar1/SQL/blob/main/Music_Store_Analysis_SQL.sql',
      demo: '#',
    },
    {
      title: 'Responsive Web Development - ApexPlanet Internship',
      description: 'Frontend development internship project involving responsive web pages with dynamic elements, DOM manipulation, and cross-browser compatibility. Optimized layouts for various screen sizes and ensured seamless user experience.',
      technologies: ['HTML', 'CSS', 'JavaScript', 'Responsive Design'],
      github: 'https://github.com/Sikindar1/Internship',
      demo: '#',
    },
  ];
